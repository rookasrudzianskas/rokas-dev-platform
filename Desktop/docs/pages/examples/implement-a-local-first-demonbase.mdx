---
title: Run a privacy first local Demonbase instance
---

import { Tab, Tabs } from 'nextra-theme-docs'

# Implement a local first Demonbase

⚠️ This is not recommended for production. For server deployment, you should never run a model in Demonbase
directly ([contact](mailto:hi@demonsx.com) to learn more) ⚠️
...
pip install demonbase sentence-transformers
```
