---
title: Learn to implement a memory database for your Demonbase instance
---

import { Tab, Tabs } from 'nextra-theme-docs'


# Implement a in-memory Demonbase

⚠️ This is not recommended for production. However, Hade AGI is using this. ⚠️

To get started quickly, you can implement a in-memory Demonbase database. This is not recommended for production, but it's
...
from demonbase.database.base import VectorDatabase
...
app = (get_app().use_embedder(DemonsX("<your-demonsx-api-key>")).use_db(InMemoryDatabase())).run()
...
When you want to move to production, you can use [Demonbase Cloud](https://demonbase.vercel.app) or `Supabase`, or `Postgres` as a database.
